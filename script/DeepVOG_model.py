...
def decoding_block(X, X_jump, filter_size, filters_num, layer_num, block_type, stage, s = 1, X_jump_t = False, up_sampling = True):
...
def DeepVOG_net(input_shape = (240, 320, 3), filter_size= (3,3)):
    ...
    # Decoding Stream
    X_out = decoding_block(X = X_out, X_jump=None, X_jump_t = True, filter_size= filter_size, filters_num= 256, 
